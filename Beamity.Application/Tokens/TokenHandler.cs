...
namespace Beamity.Application.Tokens
{
    public class TokenHandler : ITokenHandler
    {
        ...
        public TokenHandler(IOptions<TokenOptions> tokenOptionsSnapshot, SigningConfigurations signingConfigurations/*, PasswordHelper passwordHelper*/)
        {
        ...
        private RefreshToken BuildRefreshToken(User user)
        {
            ...
            (
                token : PasswordHelper.HashPassword(Guid.NewGuid().ToString()),
